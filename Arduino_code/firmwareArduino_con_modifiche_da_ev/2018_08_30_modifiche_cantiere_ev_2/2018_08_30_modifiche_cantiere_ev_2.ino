...
int destinations[] = {356, 376, 496, 569, 612, 669, 693, 712, 740, 762, 780, 794, 807, 916}; // 14 elements
...
void chooseNewDestination()
{
  ...
  //destination_idx = (++destination_idx) % 14;
  destination_idx = random(0,14);
